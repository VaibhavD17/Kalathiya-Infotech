        ...
        <>
            ...
            >
                ...
                <div className=' absolute top-[50%] left-[50%] transform -translate-x-1/2 -translate-y-1/2 '>
                    <h1 className='xl:text-[60px] md:text-[45px] text-[38px]  text-[#8A49D6] font-bold text-center lg:text-nowrap z-[-1] '>Digital Marketing</h1>
                </div>
            ...
            <div className='max-w-[1480px] w-full m-auto flex justify-between items-center lg:flex-nowrap flex-wrap gap-y-[40px]'>
                ...
                <div className='lg:w-[47%] xl:w-[55%] w-full'>
                    ...
                    <p className='text-[#555555] text-[16px] font-[400]  mt-4 mb-6 '>
                        ...
                        Digital marketing encompasses a diverse array of strategies aimed at most effective platforms to promote business and engaging with audiences in the digital realm. it contain Social Media, Search Engines, Email, Content Marketing, Camping, and more. digital marketing services Main objectives are to increase brand visibility, drive website traffic, boost conversion rates, and promote businesses.
                        <br /> <br />
                        At <span className='text-[#8A49D6] font-semibold'>Kalathiya Infotech </span> , we help brands grow their online presence, drive targeted traffic, and convert visitors into loyal customers. Our tailored digital marketing strategies are data-driven, ROI-focused, and designed to deliver measurable results.</p>

                </div>

                <div className='lg:w-[47%] xl:w-[45%] w-full'>
                    <img src='./Assets/image/digital-marketing-img.png' className='w-full object-cover max-w-[462px] m-auto' />
                </div>
                ...
                <div className='flex flex-wrap justify-between gap-y-[40px]'>
                    ...
                    <div className='p-6 rounded-[30px] lg:w-[31%] md:w-[47%]  transition ease-in-out duration-500 hover:scale-105 ' style={{ boxShadow: '0px 4px 9px 0px #8A49D6' }}>
                        <div className='flex items-start justify-between'>
                            <img src='./Assets/image/digital-icon1.svg' className=' object-cover ' />
                        ...
                        <h3 className='text-[24px] font-[700] text-black mt-6 mb-4'>SEO Essentials</h3>
                    ...
                    <div className='p-6 rounded-[30px] lg:w-[31%] md:w-[47%]  transition ease-in-out duration-500 hover:scale-105 ' style={{ boxShadow: '0px 4px 9px 0px #8A49D6' }}>
                        <div className='flex items-start justify-between'>
                            <img src='./Assets/image/digital-icon2.svg' className=' object-cover ' />
                            <div className='w-[50px] h-[50px] flex-shrink-0 rounded-full flex items-center justify-center bg-[#F0E3FF] text-black text-[35px] font-[500]'><GoArrowUpRight /></div>
                        </div>
                        <h3 className='text-[24px] font-[700] text-black mt-6 mb-4'>Content Strategies</h3>
                        <p className=" text-gray-600  mx-auto ">
                    ...
                    <div className='p-6 rounded-[30px] lg:w-[31%] md:w-[47%]  transition ease-in-out duration-500 hover:scale-105 ' style={{ boxShadow: '0px 4px 9px 0px #8A49D6' }}>
                        <div className='flex items-start justify-between'>
                            <img src='./Assets/image/digital-icon3.svg' className=' object-cover ' />
                            <div className='w-[50px] h-[50px] flex-shrink-0 rounded-full flex items-center justify-center bg-[#F0E3FF] text-black text-[35px] font-[500]'><GoArrowUpRight /></div>
                        </div>
                        <h3 className='text-[24px] font-[700] text-black mt-6 mb-4'>Social Media Trends</h3>
                        <p className=" text-gray-600  mx-auto ">
                            Social Media Trends explores the latest developments. It discusses advertising techniques, & strategies for the power of social media brand promotion & audience engagement.
                        </p>
                    </div>
                    <div className='p-6 rounded-[30px] lg:w-[31%] md:w-[47%]  transition ease-in-out duration-500 hover:scale-105 ' style={{ boxShadow: '0px 4px 9px 0px #8A49D6' }}>
                        <div className='flex items-start justify-between'>
                            <img src='./Assets/image/digital-icon4.svg' className=' object-cover ' />
                            <div className='w-[50px] h-[50px] flex-shrink-0 rounded-full flex items-center justify-center bg-[#F0E3FF] text-black text-[35px] font-[500]'><GoArrowUpRight /></div>
                        </div>
                        <h3 className='text-[24px] font-[700] text-black mt-6 mb-4'>Email Marketing Tips</h3>
                        <p className=" text-gray-600  mx-auto ">
                            Email Marketing Tips provide insights into crafting effective email campaigns. email design, automation, & practices for delivering engaging & conversion-focused email content.
                        </p>
                    </div>
                    <div className='p-6 rounded-[30px] lg:w-[31%] md:w-[47%]  transition ease-in-out duration-500 hover:scale-105 ' style={{ boxShadow: '0px 4px 9px 0px #8A49D6' }}>
                        <div className='flex items-start justify-between'>
                            <img src='./Assets/image/digital-icon5.svg' className=' object-cover ' />
                            <div className='w-[50px] h-[50px] flex-shrink-0 rounded-full flex items-center justify-center bg-[#F0E3FF] text-black text-[35px] font-[500]'><GoArrowUpRight /></div>
                        </div>
                        <h3 className='text-[24px] font-[700] text-black mt-6 mb-4'>Business Marketing</h3>
                        <p className=" text-gray-600  mx-auto ">
                    ...
                    <div className='p-6 rounded-[30px] lg:w-[31%] md:w-[47%]  transition ease-in-out duration-500 hover:scale-105 ' style={{ boxShadow: '0px 4px 9px 0px #8A49D6' }}>
                        <div className='flex items-start justify-between'>
                            <img src='./Assets/image/digital-icon6.svg' className=' object-cover ' />
                            <div className='w-[50px] h-[50px] flex-shrink-0 rounded-full flex items-center justify-center bg-[#F0E3FF] text-black text-[35px] font-[500]'><GoArrowUpRight /></div>
                        </div>
                        <h3 className='text-[24px] font-[700] text-black mt-6 mb-4'>Data Analytics Insights</h3>
                        <p className=" text-gray-600  mx-auto ">
...
const FeaturesOfDevelopment = () => {
    return (
        <section className='pt-[80px] w-full px-4 md:px-0'>
            <div className='w-full max-w-[1480px] py-[100px] relative m-auto rounded-[20px] bg-white' style={{ boxShadow: "0px 4px 9px 0px #8A49D6" }}>

                <div className='m-auto w-full text-center mb-10 px-3 z-50'>
                    <h2 className="text-[24px] font-bold text-black mb-3">
                        Features of Digital Marketing
                    </h2>
                    <p className="text-[16px] font-[400] text-[#555555] ">
                        Digital marketing encompasses a range of features aimed at promoting products, services, or brands in the online landscape. It includes diverse strategies such as social media advertising, email campaigns, and pay-per-click advertising.
                    </p>
                </div>
                ...
                <div className='flex flex-col-reverse lg:flex-row relative justify-between items-start gap-10 max-w-[1230px] m-auto px-4'>
                    ...
                    <div className='max-w-[500px] w-full absolute right-0'>
                        <img src='./Assets/Image/digital-marketing-feature.png' className='w-full h-auto object-contain z-[-1]' />
                    </div>
...
const DevelopmentProcess = () => {
    const steps = [
        { text: "PROBLEM", color: "#F6BB49" },
        { text: "STRATEGIZE", color: "#DA3D53" },
        { text: "BUILD", color: "#379AB3" },
        { text: "OPTIMIZE", color: "#3068A0" },
        { text: "PUBLISH", color: "#1A4A6F" },
        { text: "PROMOTE", color: "#1A256F" },
        { text: "TRACK", color: "#070F41" },
        { text: "REFINE", color: "#000000" },
    ];
    return (
