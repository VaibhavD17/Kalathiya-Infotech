        ...
        <>
            ...
            >
                ...
                <div className=' absolute top-[50%] left-[50%] transform -translate-x-1/2 -translate-y-1/2 '>
                    <h1 className='xl:text-[60px] md:text-[45px] text-[38px]  text-[#8A49D6] font-bold text-center lg:text-nowrap z-[-1] '>Web Application Development</h1>
                </div>
        ...
        <section className='w-full py-[80px] px-4'>
            <div className='max-w-[1480px] w-full m-auto flex justify-between items-center lg:flex-nowrap flex-wrap gap-y-[40px]'>
                ...
                <div className='lg:w-[47%] xl:w-[55%] w-full'>
                    ...
                    <p className='text-[#555555] text-[16px] font-[400]  mt-4 mb-6 '>Your custom business ideas demand a highly responsive web experience. Kalathiya Infotech’s bold approach assists clients analyze disruptive B2B or B2C challenges to create intuitive UI/UX, fully functional, and robust web technology solutions. <br /> <br />

                        Whether it's building intuitive user interfaces, implementing complex backend functionality, or ensuring seamless performance across devices, we're dedicated to delivering high-quality web applications that drive success and exceed expectations. Partner with us to transform your vision into reality and elevate your online presence.</p>


                </div>

                <div className='lg:w-[47%] xl:w-[45%] w-full'>
                    <img src='./Assets/image/web-development-img.png' className='w-full object-cover max-w-[462px] m-auto' />
                </div>
                ...
                <div className='flex flex-wrap justify-between gap-y-[40px]'>
                    ...
                    <div className='p-6 rounded-[30px] lg:w-[31%] md:w-[47%] transition ease-in-out duration-500 hover:scale-105 ' style={{ boxShadow: '0px 4px 9px 0px #8A49D6' }}>
                        ...
                        <p className=" text-gray-600  mx-auto ">
                            We offer customized and quality website development services for your business. Hire the top custom web development company cost-effectively.
                        </p>
                    </div>
                    <div className='p-6 rounded-[30px] lg:w-[31%] md:w-[47%] transition ease-in-out duration-500 hover:scale-105 ' style={{ boxShadow: '0px 4px 9px 0px #8A49D6' }}>
                        <div className='flex items-start justify-between'>
                        ...
                        <p className=" text-gray-600  mx-auto ">
                            Our wide range of web portal development services helps you get the complete chain of business verticals using versatile development experience.
                    ...
                    <div className='p-6 rounded-[30px] lg:w-[31%] md:w-[47%] transition ease-in-out duration-500 hover:scale-105 ' style={{ boxShadow: '0px 4px 9px 0px #8A49D6' }}>
                        ...
                        <p className=" text-gray-600  mx-auto ">
                            We will provide intellectual resolution for your business as we have delivered a complete business project of the E-commerce platform for B2B and B2C businesses.
                    ...
                    <div className='p-6 rounded-[30px] lg:w-[31%] md:w-[47%] transition ease-in-out duration-500 hover:scale-105 ' style={{ boxShadow: '0px 4px 9px 0px #8A49D6' }}>
                        ...
                        <p className=" text-gray-600  mx-auto ">
                            Find our post-development support and accessible web maintenance services to keep your website updated and function hassle-free.
