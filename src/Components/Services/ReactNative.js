        ...
        <>
            ...
            >
                ...
                <div className=' absolute top-[50%] left-[50%] transform -translate-x-1/2 -translate-y-1/2 '>
                    <h1 className='xl:text-[60px] md:text-[45px] text-[38px]  text-[#8A49D6] font-bold text-center lg:text-nowrap z-[-1] '>React Native</h1>
                </div>
            ...
            <div className='max-w-[1480px] w-full m-auto flex justify-between items-center lg:flex-nowrap flex-wrap gap-y-[40px]'>
                ...
                <div className='lg:w-[47%] xl:w-[55%] w-full'>
                    ...
                    <p className='text-[#555555] text-[16px] font-[400]  mt-4 mb-6 '>
                        <span className='text-[#8A49D6] font-semibold'>Kalathiya Infotech </span> specializes in crafting cutting-edge web solutions tailored to meet the unique demands of businesses. Our innovative approach enables us to effectively address complex challenges in both B2B and B2C environments. We excel in developing user-friendly interfaces, seamless user experiences, and resilient web technologies that empower our clients to thrive in today's dynamic digital landscape.
                        <br /> <br />
                        We streamline the development process without compromising on performance or user experience. Our team of experienced developers leverages the flexibility and efficiency of React Native to build immersive and feature-rich mobile apps that cater to diverse audiences. Whether you're targeting iOS, Android, or both, we're dedicated to delivering seamless user experiences, rapid development cycles, and cost-effective solutions.
                    </p>
            ...
            <div className="max-w-[1480px] w-full mx-auto px-4 py-[100px]" >
                <div className='max-w-[1260px]'>
                    ...
                    <p className=" text-[#555555]  mb-10">
                        <span className='text-[#8A49D6] font-[700]'>Kalathiya Infotech</span>  is a highly esteemed provider of website development services, serving diverse industries with our tailored and personalized approach.
                    </p>
                </div>
...
const DevelopmentProcess = () => {
    const steps = [
        { text: "Reusable Components", color: "#F6BB49" },
        { text: "UI Focused", color: "#DA3D53" },
        { text: "mobile environment performance", color: "#3FA8BC" },
        { text: "npm for installation", color: "#336699" },
        { text: "strong community", color: "#204E68" },
        { text: "strong community", color: "#1B2463" },
    ];
    return (
