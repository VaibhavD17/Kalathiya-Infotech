        ...
        <>
            ...
            >
                ...
                <div className=' absolute top-[50%] left-[50%] transform -translate-x-1/2 -translate-y-1/2 '>
                    <h1 className='xl:text-[60px] md:text-[45px] text-[38px]  text-[#8A49D6] font-bold text-center lg:text-nowrap z-[-1] '>Mobile Application Development</h1>
                </div>
        ...
        <section className='w-full py-[80px] px-4'>
            <div className='max-w-[1480px] w-full m-auto flex justify-between items-center lg:flex-nowrap flex-wrap gap-y-[40px]'>
                <div className='lg:w-[47%] xl:w-[45%] w-full'>
                    <img src='./Assets/image/mobile-dev.png' className='w-full object-cover max-w-[462px] m-auto' />
                </div>

                <div className='lg:w-[47%] xl:w-[55%] w-full'>

                    <p className='text-[#555555] text-[16px] font-[400]  mt-4 mb-6 '>
                        We are leading mobile application development services with more than a decade of experience and expertise. Get remarkable mobile applications with an innovative approach for small to large scale enterprises.
                        <br /> <br />
                        At <span className='text-[#8A49D6] font-semibold'>Kalathiya Infotech</span>, we specialize in crafting high-performance, user-friendly mobile applications that help businesses stay ahead in the digital era. Whether you're a startup or an established enterprise, our custom mobile app solutions are designed to meet your unique needs and drive real results.
                    </p>
                </div>
            ...
            <div className="max-w-[1480px] w-full mx-auto px-4 py-[100px]" >
                <div className='max-w-[1260px]'>
                    ...
                    <p className=" text-[#555555]  mb-10">
                        <span className='text-[#8A49D6] font-[700]'>The Kalathiya Infotech </span>
                        is a renowned website development service company catering to various industries with our bespoke website development services.
                    </p>
                </div>
                ...
                <div className='flex flex-wrap justify-between gap-y-[30px]'>
                    ...
                    <div className='p-6 rounded-[30px] lg:w-[31%] md:w-[47%] min-h-[338px]  transition ease-in-out duration-500 hover:scale-105 ' style={{ boxShadow: '0px 4px 9px 0px #8A49D6' }}>
                        <div className='flex items-start justify-between'>
                            <img src='./Assets/image/android-icon.svg' className=' object-cover ' />
                    ...
                    <div className='p-6 rounded-[30px] lg:w-[31%] md:w-[47%] min-h-[338px]  transition ease-in-out duration-500 hover:scale-105 ' style={{ boxShadow: '0px 4px 9px 0px #8A49D6' }}>
                        <div className='flex items-start justify-between'>
                            <img src='./Assets/image/iphone-icon.svg' className=' object-cover ' />
                            <div className='w-[50px] h-[50px] flex-shrink-0 rounded-full flex items-center justify-center bg-[#F0E3FF] text-black text-[35px] font-[500]'><GoArrowUpRight /></div>
                        </div>
                        <h3 className='text-[24px] font-[700] text-black mt-6 mb-4'>
                    ...
                    <div className='p-6 rounded-[30px] lg:w-[31%] md:w-[47%] min-h-[338px]  transition ease-in-out duration-500 hover:scale-105 ' style={{ boxShadow: '0px 4px 9px 0px #8A49D6' }}>
                        <div className='flex items-start justify-between'>
                            <img src='./Assets/image/hybrid-icon.svg' className=' object-cover ' />
                            <div className='w-[50px] h-[50px] flex-shrink-0 rounded-full flex items-center justify-center bg-[#F0E3FF] text-black text-[35px] font-[500]'><GoArrowUpRight /></div>
                        </div>
                        <h3 className='text-[24px] font-[700] text-black mt-6 mb-4'>
                    ...
                    <div className='p-6 rounded-[30px] lg:w-[31%] md:w-[47%] min-h-[338px]  transition ease-in-out duration-500 hover:scale-105 ' style={{ boxShadow: '0px 4px 9px 0px #8A49D6' }}>
                        <div className='flex items-start justify-between'>
                            <img src='./Assets/image/platform-icon.svg' className=' object-cover ' />
                            <div className='w-[50px] h-[50px] flex-shrink-0 rounded-full flex items-center justify-center bg-[#F0E3FF] text-black text-[35px] font-[500]'><GoArrowUpRight /></div>
                        </div>
                        <h3 className='text-[24px] font-[700] text-black mt-6 mb-4'>
                    ...
                    <div className='p-6 rounded-[30px] lg:w-[31%] md:w-[47%] min-h-[338px]  transition ease-in-out duration-500 hover:scale-105 ' style={{ boxShadow: '0px 4px 9px 0px #8A49D6' }}>
                        <div className='flex items-start justify-between'>
                            <img src='./Assets/image/enterprise-icon.svg' className=' object-cover ' />
                            <div className='w-[50px] h-[50px] flex-shrink-0 rounded-full flex items-center justify-center bg-[#F0E3FF] text-black text-[35px] font-[500]'><GoArrowUpRight /></div>
                        </div>
                        <h3 className='text-[24px] font-[700] text-black mt-6 mb-4'>
            ...
            <div className='w-full max-w-[1480px] py-[50px] relative m-auto rounded-[20px] bg-white' style={{ boxShadow: "0px 4px 9px 0px #8A49D6" }}>
                ...
                <div className='m-auto w-full text-center mb-10 px-3'>
                    ...
                    <p className="text-[16px] font-[400] text-[#555555]">
                       Mobile app development is a crucial software process in today’s world of digitalization and technology. Everyone uses mobile apps due to their user-friendliness and flexibility.
                    </p>
                </div>
...
const DevelopmentProcess = () => {
    const steps = [
        { text: "Strategy", color: "#F6BB49" },
        { text: "Analusis and Planning", color: "#DA3D53" },
        { text: "UI/UX Design", color: "#379AB3" },
        { text: "App Development", color: "#3068A0" },
        { text: "Testing", color: "#1A4A6F" },
        { text: "Deployment & Support", color: "#1A256F" },
    ];
    return (
            ...
            <div className='w-full max-w-[1480px] m-auto'>
                <div className='  mb-10 md:px-0 w-fit '>
                    <h2 className="sm:text-[26px] uppercase text-[24px] font-bold text-black mb-3">
                        Key Steps to Mobile App Development Process
                    </h2>
